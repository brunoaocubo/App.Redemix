import {ProcessJson} from '@core/api.js'
let subsidiaries = await ProcessJson('/data/subsidiarys.json')
let pdvs_registred = await ProcessJson('/data/pdvregistred.json')
